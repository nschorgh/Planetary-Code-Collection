...
C***********************************************************************
      ...
      real*8 psv, avdrho, rtbis, junk, Tb, frostpoint, p0
...
C        Empirical relation from Mellon & Jakosky:
         ...
         pfrost = psv(Tfrost)
         Tb = -1.e32
         !fracIR=0.04*p0/600.; fracDust=0.02*p0/600.  ! overwrites
...
c      print *,x2,fmid
     ...
     &     Fgeotherm,dt,zfac,icefrac,surfaceSlope,azFac,0,f,Tb,patm)
      ...
      do j=1,JMAX
        ...
        call jsub(xmid,
     &     latitude,albedo0,thIn,pfrost,nz/2,rhoc,fracIR,fracDust,
     &     Fgeotherm,4.*dt,zfac,icefrac,surfaceSlope,azFac,1,fmid,
     &     Tb,patm)
        call jsub(xmid,
     &     latitude,albedo0,thIn,pfrost,nz,rhoc,fracIR,fracDust,
